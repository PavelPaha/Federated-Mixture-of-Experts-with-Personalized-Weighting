...
from fastmoe.fmoe.gates.utils import limit_by_capacity
...
class GShardGate(NaiveGate):
    ...
    def raw_forward(self, x, return_all_scores=False):
        ...
        if return_all_scores:
            return topk_idx, topk_val, F.softmax(gate_score, dim=1)
        return topk_idx, topk_val

    def forward(self, x, return_all_scores=True):
        return self.raw_forward(x, return_all_scores=return_all_scores)